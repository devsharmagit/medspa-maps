...
export const STATE_CONTENT: Record<string, StateContent> = {
  TX: {
    ...
    metaDescription:
      "Explore vetted med spas across Texas — Houston, Dallas, Austin, San Antonio and beyond. Compare treatments, ratings, and locations on Medspa Maps.",
    extraFaqs: [
      {
  ...
  CA: {
    ...
    metaDescription:
      "Find vetted med spas across California — Los Angeles, San Diego, the Bay Area, and Orange County. Compare treatments, ratings, and locations on Medspa Maps.",
    extraFaqs: [
      {
  ...
  FL: {
    ...
    metaDescription:
      "Discover vetted med spas across Florida — Miami, Orlando, Tampa, Jacksonville and more. Compare treatments, ratings, and locations on Medspa Maps.",
    extraFaqs: [
      {
  ...
  NY: {
    ...
    metaDescription:
      "Browse vetted med spas across New York — Manhattan, Long Island, Westchester, and upstate. Compare treatments, ratings, and locations on Medspa Maps.",
    extraFaqs: [
      {
  ...
  UT: {
    ...
    metaDescription:
      "Find vetted med spas across Utah — Salt Lake City, Lehi, Provo, and the Wasatch Front. Compare treatments, ratings, and locations on Medspa Maps.",
    extraFaqs: [
      {
  ...
  AZ: {
    ...
    metaDescription:
      "Explore vetted med spas across Arizona — Phoenix, Scottsdale, Tucson, and beyond. Compare treatments, ratings, and locations on Medspa Maps.",
    extraFaqs: [
      {
  ...
  GA: {
    ...
    metaDescription:
      "Discover vetted med spas across Georgia — Atlanta, Savannah, Augusta, and more. Compare treatments, ratings, and locations on Medspa Maps.",
    extraFaqs: [
      {
  ...
  PA: {
    ...
    metaDescription:
      "Browse vetted med spas across Pennsylvania — Philadelphia, Pittsburgh, and beyond. Compare treatments, ratings, and locations on Medspa Maps.",
    extraFaqs: [
      {
  ...
  TN: {
    ...
    metaDescription:
      "Find vetted med spas across Tennessee — Nashville, Memphis, Knoxville, and Chattanooga. Compare treatments, ratings, and locations on Medspa Maps.",
    extraFaqs: [
      {
  ...
  WA: {
    ...
    metaDescription:
      "Explore vetted med spas across Washington — Seattle, Bellevue, Spokane, and beyond. Compare treatments, ratings, and locations on Medspa Maps.",
    extraFaqs: [
      {
  ...
  NC: {
    ...
    metaDescription:
      "Discover vetted med spas across North Carolina — Charlotte, Raleigh, Durham, and more. Compare treatments, ratings, and locations on Medspa Maps.",
    extraFaqs: [
      {
  ...
  IL: {
    ...
    metaDescription:
      "Browse vetted med spas across Illinois — Chicago and the surrounding suburbs. Compare treatments, ratings, and locations on Medspa Maps.",
    extraFaqs: [
      {
...
export function stateContent(abbr: string, stateName: string): StateContent {
  return (
    STATE_CONTENT[abbr] ?? {
      intro: `Explore vetted med spas across ${stateName}. Compare treatments, patient ratings, and locations, then book directly with the practice — all on Medspa Maps.`,
      metaDescription: `Find vetted med spas across ${stateName}. Compare treatments, ratings, and locations on Medspa Maps.`,
    }
  );
}
